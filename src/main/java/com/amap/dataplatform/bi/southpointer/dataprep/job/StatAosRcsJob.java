...
public class StatAosRcsJob extends Configured implements Tool{
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new StatAosRcsJob(),  args);
	...
	public int run(String[] arg0) throws Exception {
		...
		Job job = new Job(conf,"stat_aos_rcs job");
	 	job.setJarByClass(StatAosRcsJob.class);
    	job.setMapperClass(StatAosRcsMapper.class);
    	job.setReducerClass(StatAosRcsReducer.class);
    	job.setMapOutputKeyClass(Text.class);
    	job.setMapOutputValueClass(Text.class);
    	job.setOutputKeyClass(Text.class);
    	job.setOutputValueClass(NullWritable.class);
    	job.setNumReduceTasks(100);
		String inputPathString = conf.get("mapred.job.stataosrcs.input.datapath.template", "");
		...
		String outputPathString = conf.get("mapred.job.stataosrcs.output.datapath.template", "");
